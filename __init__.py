...
NODE_CLASS_MAPPINGS = {
    ...
    "RH_MINIMAX_H3_MODEL_SELECTOR": RH_MiniMaxH3ModelSelector_Node,
    "RH_MINIMAX_H3_STORYBOARD_GUIDE": RH_MiniMaxH3StoryboardGuide_Node,
    "RH_MINIMAX_H3_SETTINGS": RH_MiniMaxH3Settings_Node,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "RH_MINIMAX_H3_MODEL_SELECTOR": "RH Storyboard - MiniMax H3 Guide Model Selector",
    "RH_MINIMAX_H3_STORYBOARD_GUIDE": "RH Storyboard - MiniMax H3 Image Guide",
    "RH_MINIMAX_H3_SETTINGS": "RH Storyboard - MiniMax H3 Settings",
